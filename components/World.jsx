...
export function World(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <pointLight name="bonfire_light" intensity={1.514} decay={2} color="#ff7c2f" position={[-1.164, -0.769, 1.373]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} />
        ...
        <mesh name="lake" geometry={nodes.lake.geometry} material={materials.water} position={[-5.511, -1.75, -3.538]} scale={[2.834, 3.904, 2.472]} />
        ...
        <group name="avatar" position={[-0.504, -0.228, 0.546]} rotation={[-0.049, 0.408, 0.277]} scale={[1, 0.942, 1]}>
          <mesh name="Plane005" geometry={nodes.Plane005.geometry} material={materials['black tshirt']} />
          <mesh name="Plane005_1" geometry={nodes.Plane005_1.geometry} material={materials.hair_black} />
          <mesh name="Plane005_2" geometry={nodes.Plane005_2.geometry} material={materials.skin} />
          <mesh name="Plane005_3" geometry={nodes.Plane005_3.geometry} material={materials.hair_grey} />
          <mesh name="Plane005_4" geometry={nodes.Plane005_4.geometry} material={materials.bronze} />
          <mesh name="Plane005_5" geometry={nodes.Plane005_5.geometry} material={materials.arch_glass} />
          <mesh name="Plane005_6" geometry={nodes.Plane005_6.geometry} material={materials.grey_dark} />
        </group>
        <group name="book_shelves" position={[0.014, 0.092, -0.608]} rotation={[0, 1.571, 0]}>
          ...
          <mesh name="Cube036_7" geometry={nodes.Cube036_7.geometry} material={materials.brown_wood} />
          <mesh name="Cube036_8" geometry={nodes.Cube036_8.geometry} material={materials.window_frame} />
        </group>
        ...
        <group name="walls&floor" position={[0, -0.476, 0]} rotation={[0, 1.571, 0]}>
          <mesh name="Plane" geometry={nodes.Plane.geometry} material={materials.carpet} />
          <mesh name="Plane_1" geometry={nodes.Plane_1.geometry} material={materials.wall_material} />
          <mesh name="Plane_2" geometry={nodes.Plane_2.geometry} material={materials.window_frame} />
          <mesh name="Plane_3" geometry={nodes.Plane_3.geometry} material={materials.arch_glass} />
        </group>
        ...
        <group name="NES" position={[0.408, -0.198, -0.338]} rotation={[-Math.PI, 1.571, 0]} scale={[-0.008, -0.001, -0.003]}>
          ...
          <mesh name="Cube193_9" geometry={nodes.Cube193_9.geometry} material={materials.NES_LOGO} />
        </group>
        ...
        <group name="posters" position={[0.054, 0.177, -0.396]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={[0.168, 1, 0.233]}>
          <mesh name="Plane002" geometry={nodes.Plane002.geometry} material={materials.et} />
          <mesh name="Plane002_1" geometry={nodes.Plane002_1.geometry} material={materials.final_fantasy} />
          <mesh name="Plane002_2" geometry={nodes.Plane002_2.geometry} material={materials.b2f} />
          <mesh name="Plane002_3" geometry={nodes.Plane002_3.geometry} material={materials.monkey_island} />
          <mesh name="Plane002_4" geometry={nodes.Plane002_4.geometry} material={materials.mega_man} />
        </group>
        <group name="pc&floppies" position={[0.115, 0.014, -0.371]}>
          <mesh name="Plane015" geometry={nodes.Plane015.geometry} material={materials.white_striped_paper} />
          <mesh name="Plane015_1" geometry={nodes.Plane015_1.geometry} material={materials.floppy_disk_black} />
          <mesh name="Plane015_2" geometry={nodes.Plane015_2.geometry} material={materials.silver_metal} />
          <mesh name="Plane015_3" geometry={nodes.Plane015_3.geometry} material={materials.floppy_disk_blue} />
          <mesh name="Plane015_4" geometry={nodes.Plane015_4.geometry} material={materials.rough_plastic_beige} />
          <mesh name="Plane015_5" geometry={nodes.Plane015_5.geometry} material={materials.rough_plastic_dark_beige} />
          <mesh name="Plane015_6" geometry={nodes.Plane015_6.geometry} material={materials.rough_plastic_GREY} />
          <mesh name="Plane015_7" geometry={nodes.Plane015_7.geometry} material={materials.green_emission} />
          <mesh name="Plane015_8" geometry={nodes.Plane015_8.geometry} material={materials.metalic_light_grey} />
          <mesh name="Plane015_9" geometry={nodes.Plane015_9.geometry} material={materials.grey_dark} />
          <mesh name="Plane015_10" geometry={nodes.Plane015_10.geometry} material={materials.smooth_plastic_grey} />
        </group>
        <group name="table" position={[0.071, -0.538, -0.354]} rotation={[0, 1.571, 0]} scale={[1, 1, 0.932]}>
          <mesh name="Cube" geometry={nodes.Cube.geometry} material={materials.brown_wood} />
          <mesh name="Cube_1" geometry={nodes.Cube_1.geometry} material={materials.white_wood} />
          <mesh name="Cube_2" geometry={nodes.Cube_2.geometry} material={materials.bronze} />
        </group>
        ...
        <group name="VCR001" position={[-0.466, -0.144, -0.403]} rotation={[0, -1.571, 0]} scale={[0.056, 0.383, 0.466]}>
          <mesh name="Cube006" geometry={nodes.Cube006.geometry} material={materials.smooth_plastic_black} />
          <mesh name="Cube006_1" geometry={nodes.Cube006_1.geometry} material={materials.smooth_plastic_grey} />
          <mesh name="Cube006_2" geometry={nodes.Cube006_2.geometry} material={materials.arch_glass} />
          <mesh name="Cube006_3" geometry={nodes.Cube006_3.geometry} material={materials.white} />
        </group>
